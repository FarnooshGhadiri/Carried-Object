function codebook = proc_codebook_oneimage_circlebin(m_Center,pb_edge,pb_theta,obj_mask,sc_mask,para_sc)
% codebook =
% proc_codebook_oneimage_circlebin(pb_edge,pb_theta,obj_mask,sc_mask,para_sc)
% 
% 
...
% % % % % % % % If the given img is test, comput Mask Center else read from
% the stored center
% % mask_center = get_mask_center(obj_mask);

% % %% % % % In the training Set

mask_center=round(m_Center);
